...
1. Confirm impact and stop promotion/deployment if users may be harmed.
2. Preserve minimal, non-sensitive diagnostic evidence; never paste secrets or customer data into issues.
3. Disable the affected feature or roll back to the last known-good deployment.
