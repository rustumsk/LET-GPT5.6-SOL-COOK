...
Track `landing_viewed`, `calculator_started`, `calculator_completed`, `preview_generated`, `copy_clicked`, and `interview_intent` using a vendor-neutral adapter. During local/static validation events stay in the browser; production analytics requires privacy review.
