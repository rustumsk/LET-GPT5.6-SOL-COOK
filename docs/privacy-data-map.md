...
No names, email addresses, client data, cookies, or sensitive data are collected in the first asset. Before persistence or third-party analytics, update this map, publish a privacy notice, define retention, deletion/export, processors, access controls, and consent/legal basis.
